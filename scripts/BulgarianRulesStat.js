...
for (let i = 0; i < rulers.length; i++) {
    var ruler = rulers[i];
    var rulerName = ruler[i];
    var rulerYearsInPower = ruler[2] - ruler[1];

if (rulerYearsInPower > 15) {
    
	console.log(toCamelCaseCyr(ruler[0]), 'е управлявал', rulerYearsInPower, 'години.');
